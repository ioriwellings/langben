<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Index.Master" Inherits="System.Web.Mvc.ViewPage<Langben.DAL.SysDepartment>" %>
    ...
    <script type="text/javascript" language="javascript">
        $(function () {
            ...
            $('#flexigridData').datagrid({
                ...
                striped: true,
                collapsible: true,
                url: '../SysDepartment/GetData', //获取数据的url
                sortName: 'Id',
                sortOrder: 'desc',
                idField: 'Id',
        ...
        function getView() {
            ...
            if (arr.length == 1) {
                window.location.href = "../SysDepartment/Details/" + arr[0].Id;
        ...
        function flexiModify() {
            ...
            if (arr.length == 1) {
                window.location.href = "../SysDepartment/Edit/" + arr[0].Id;
