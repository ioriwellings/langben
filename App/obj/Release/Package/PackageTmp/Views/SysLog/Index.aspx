...
<%@ Import Namespace="Langben.DAL" %>

<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Index.Master" Inherits="System.Web.Mvc.ViewPage<Langben.DAL.SysLog>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="left03">
        <input class="submitcss" type="button" value="查 询" onclick="flexiQuery()" />
    </div>
</asp:Content>
        ...
        $(function () {
            ...
            $('#flexigridData').datagrid({
                ...
                columns: [[
					...
					, { field: 'Ip', title: '<%: Html.DisplayNameFor(model => model.Ip) %>', width: 83 }
