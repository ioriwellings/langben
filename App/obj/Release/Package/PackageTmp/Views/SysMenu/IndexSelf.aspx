<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Index.Master" Inherits="System.Web.Mvc.ViewPage<Langben.DAL.SysMenu>" %>
...
//					,{ field: 'Remark', title:  '<%: Html.LabelFor(model => model.Remark) %>', width: 84 }
        ...
        function getView() {
            ...
            if (arr.length == 1) {
                window.location.href = "../SysMenu/Details/" + arr[0].Id;
        ...
        function flexiModify() {
            ...
            if (arr.length == 1) {
                window.location.href = "../SysMenu/Edit/" + arr[0].Id;
