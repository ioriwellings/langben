<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Create.Master" Inherits="System.Web.Mvc.ViewPage<Langben.DAL.SysMenuSysRoleSysOperation>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <fieldset>
        ...
        <div class="editor-label">
            <a class="anUnderLine" onclick="showModalOnly('SysMenuId','../../SysMenu');">
        ...
        <div class="editor-label">
            <a class="anUnderLine" onclick="showModalOnly('SysRoleId','../../SysRole');">
        ...
        <div class="editor-label">
            <a class="anUnderLine" onclick="showModalOnly('SysOperationId','../../SysOperation');">
