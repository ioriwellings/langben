<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Index.Master" Inherits="System.Web.Mvc.ViewPage<Langben.DAL.SysRole>" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="HeadContent" runat="server">
    <script type="text/javascript" language="javascript">
        ...
        function flexiModify() {
            ...
            if (arr.length == 1) {
                window.location.href = "../SysRole/Edit/" + arr[0].Id;
        ...
        flexiSetSysMenu = function () {
            ...
            if (arr.length == 1) {
                showMyWindow("分配权限", "../SysRole/SetSysMenu/" + arr[0].Id);
                //window.location.href = "../SysRole/SetSysMenu/" + arr[0].Id;
