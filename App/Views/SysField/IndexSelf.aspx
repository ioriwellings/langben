<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Index.Master" Inherits="System.Web.Mvc.ViewPage<Langben.DAL.SysField>" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function getView() {
            ...
            if (arr.length == 1) {
                window.location.href = "../SysField/Details/" + arr[0].Id;
        ...
        function flexiModify() {
            ...
            if (arr.length == 1) {
                window.location.href = "../SysField/Edit/" + arr[0].Id;
